...
async def cmd_start(m: types.Message):
    ...
    await m.answer(
        ...
        "🔻 <b>Шорт-бот</b> — детектор перегретых монет для SHORT, "
        "7 сигналов + фильтры\n"
        "📈 <b>Stocks (MOEX)</b> — торговля акциями через BCS API, "
        "6 стратегий, авто и полуавто режимы\n\n"
        "Выберите действие:",
